...
public class JsonAdaptedAttendanceTest {
    ...
    private static final List<String> VALID_LIST = convertIntListToStringList(E0123456.getAttendanceList());
    private static final String VALID_NUSNETID = E0123456.getStudentId().toString();
    private static final String VALID_COMMENT = E0123456.getComment().toString();

    @Test
    public void toModelType_validAttendanceDetails_returnsAttendance() throws Exception {
        JsonAdaptedAttendance attendance = new JsonAdaptedAttendance(E0123456);
        assertEquals(E0123456, attendance.toModelType());
    }

    @Test
    public void toModelType_emptyList_throwsIllegalValueException() {
        JsonAdaptedAttendance attendance = new JsonAdaptedAttendance(VALID_NUSNETID,
    ...
    public void toModelType_invalidNusNetId_throwsIllegalValueException() {
        JsonAdaptedAttendance attendance = new JsonAdaptedAttendance(INVALID_NUSNETID,
    ...
    public void toModelType_nullComment_throwsIllegalValueException() {
        JsonAdaptedAttendance attendance = new JsonAdaptedAttendance(VALID_NUSNETID, null, VALID_LIST);
        String expectedMessage = String.format(JsonAdaptedAttendance.MISSING_FIELD_MESSAGE_FORMAT,
