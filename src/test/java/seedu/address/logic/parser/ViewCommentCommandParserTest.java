...
public class ViewCommentCommandParserTest {
    private ViewCommentCommandParser parser = new ViewCommentCommandParser();
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, " id/" + VALID_STUDENT_ID_AARON,
                new ViewCommentCommand(expectStudentId));
    ...
    public void parse_compulsoryFieldMissing_failure() {
        String expectedMessage = String.format(MESSAGE_INVALID_COMMAND_FORMAT,
                ViewCommentCommand.MESSAGE_USAGE);
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, PREAMBLE_NON_EMPTY + " id/" + VALID_STUDENT_ID_AARON,
                String.format(MESSAGE_INVALID_COMMAND_FORMAT, ViewCommentCommand.MESSAGE_USAGE));
