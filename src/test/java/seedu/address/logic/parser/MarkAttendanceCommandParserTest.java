...
public class MarkAttendanceCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + TUTORIALNAME_DESC_T01 + " id/" + VALID_STUDENT_ID_AARON
                + WEEKS_DESC_T01,
                new MarkAttendanceCommand(expectedTutorialName, expectStudentId, expectedWeeks, false));

        // studentId not given (multiple attendance marking)
        assertParseSuccess(parser, TUTORIALNAME_DESC_T01 + WEEKS_DESC_T01,
                new MarkAttendanceCommand(expectedTutorialName, null, expectedWeeks, true));
